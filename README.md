...
La aplicación se ejecuta exclusivamente desde terminal.
...
La aplicación se ejecuta desde terminal exclusivamente. Solicita contraseña de administrador una sola vez.
